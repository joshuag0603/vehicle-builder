...
class Truck extends Vehicle implements AbleToTow {
  ...
  constructor(
    ...
    // Initialize the Truck properties
    this.vin = vin;
    this.color = color;
    this.make = make;
    this.model = model;
    ...
    if (wheels.length !== 4) {
      this.wheels = Array(4).fill(new Wheel()); // Create 4 new default Wheel objects
    } else {
      this.wheels = wheels;
    }
  }
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    ...
    if (vehicle.weight <= this.towingCapacity) {
      ...
      console.log(`${vehicleDetails} is too heavy to be towed by the truck.`);
    }
  }

  // Override the printDetails method from the Vehicle class
  override printDetails(): void {
    super.printDetails(); // Call the parent class method to print common vehicle details
